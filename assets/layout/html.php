...
<div class="wrapper">
  ...
  <footer class="main-footer">
      ...
      <strong><?php echo date('Y');?> Arisan Online All rights
      reserved.
    </footer>
  ...
  <!-- DataTables -->
  <script src="<?php echo Route::getAssethPath('plugins/datatables/jquery.dataTables.js');?>"></script>
  <script src="<?php echo Route::getAssethPath('plugins/datatables-bs4/js/dataTables.bootstrap4.js');?>"></script>
  </body>
  </html>
